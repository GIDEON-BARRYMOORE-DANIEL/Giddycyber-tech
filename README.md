 Gideon Barrymoore Daniel – Cybersecurity Analyst

👋 Hello! I’m Gideon Barrymoore Daniel, a results-driven Cybersecurity Analyst with two years of experience protecting cloud and on-prem infrastructures. My work focuses on threat detection, vulnerability management, and continuous security monitoring. This repository gathers the lab projects and reference guides that demonstrate my technical depth and commitment to secure-by-design principles.
...
| 02-ad-deployment | Installing and hardening Active Directory | [View Repo](https://github.com/GIDEON-BARRYMOORE-DANIEL/step-by-step-creation-of-a-small-active-directory-IAM-lab-using-windows-8.1-server.git) |
| 03-AWS-deployment | Configuration and hardening Cloud console in AWS | [View Repo](https://github.com/GIDEON-BARRYMOORE-DANIEL/aws-cloud-governance-iam-project) |
| 04-security-policy-dev | Crafting AUP, password, and ACL policies | [View Repo](#) |
| 05-vulnerability-assessment | Network and web-app scanning with Nessus and Nmap | [View Repo](https://github.com/GIDEON-BARRYMOORE-DANIEL/vulnerability-assessment-lab.git) |
| 06-network-monitoring | Security Onion and Splunk dashboards | [View Repo](#) |
| 07-risk-assessment | CIA impact mapping and risk matrix | [View Repo](#) |
| 08-mitre-threat-hunt | ATT&CK-aligned threat hunting scripts | [View Repo](https://github.com/GIDEON-BARRYMOORE-DANIEL/threat-hunting-apt-ttp-analysis-mitre-attack-uk-insurance.git) |
...
- **LinkedIn:** <www.linkedin.com/in/gideon-daniel-63b800270>  
- **Email:** <gideondaniel760@gmail.com>  
